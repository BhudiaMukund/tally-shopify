...
# Reports Mongo, Redis, Garage and Shopify reachability plus queue depth
# (commit 11) — a stronger signal than "the server answers a GET", which is
# all /login proved before this route existed.
